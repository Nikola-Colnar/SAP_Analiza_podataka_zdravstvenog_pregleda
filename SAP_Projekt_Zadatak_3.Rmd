...
Sljedece sto zelimo provjeriti je razlikuje li se prosječni krvni tlak značajno medu skupinama s različitom učestalošću tjelesne aktivnosti. Naravno prvo učitavamo podatke i potrebne biblioteke.
...
Nakon toga filtriramo podatke kako bi izbacili nerealne vrijednosti i uvodimo šum budući da su podaci uglavnom zaokruzivani na 10 te ih treba razlozit na ostale vrijednosti. Za šum koristimo uniformnu distribuciju ograničenu na +-5. 
...
Iz plotova vidimo kako su vrijednosti krvnih tlakova dosla slične kod aktivnih i neaktivnih ljudi. Ipak kako ne bi ostali na tome provjerit ćemo jednakos sredina odgovarajucim testovima.
