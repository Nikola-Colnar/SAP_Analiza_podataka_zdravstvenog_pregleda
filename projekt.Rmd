...
### Višestruka regresija za sistolički tlak
...
#### Zaključak
Iz konteksta medicine smatramo da je dobivena $R^2_{adj}$ premalena kako bismo mogli predviđati sistolički krvni tlak.
...
```
Zaključak je da reziduali nisu distribuirani normalno. Možemo vidjeti njihov grafički prikaz u nastavku.
```{r}
...
Iz konteksta medicine smatramo da je dobivena $R^2_{adj}$ premalena kako bismo mogli predviđati dijastolički krvni tlak.
# Zaključak projekta
