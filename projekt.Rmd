...
par(mfrow=c(1,2))
bpd <- data.frame(sistolički=pusaci$ap_hi, dijastolički=pusaci$ap_lo)
boxplot(bpd, main='box-plot tlaka pušača',
        ylab='tlak/mmHg')
bpd <- data.frame(sistolički=nepusaci$ap_hi, dijastolički=nepusaci$ap_lo)
...
par(mfrow = c(2,2))
qqnorm(pusaci$ap_hi, main = "sist. tlak pušača", xlab="kvantili normalne razdiobe", ylab="kvantili uzorka")
qqline(pusaci$ap_hi, col="blue")
qqnorm(nepusaci$ap_hi, main = "sist. tlak nepušača", xlab="kvantili normalne razdiobe", ylab="kvantili uzorka")
qqline(nepusaci$ap_hi, col="red")
qqnorm(pusaci$ap_lo, main = "dijast. tlak pušača", xlab="kvantili normalne razdiobe", ylab="kvantili uzorka")
qqline(pusaci$ap_lo, col="blue")
qqnorm(nepusaci$ap_lo, main = "dijast. tlak nepušača", xlab="kvantili normalne razdiobe", ylab="kvantili uzorka")
...
plot(selected.model$fitted.values,selected.model$residuals, main="residuals", xlab="fitted.values")
plot(filtered_data$BMI, selected.model$residuals, main="residuals", xlab="BMI")
plot(filtered_data$age, selected.model$residuals, main="residuals", xlab = "age")
```
...
```{r}
fit.multi <- lm(ap_lo ~ BMI + active + AgeinYr, filtered_data) #ako maknete regresore koji su manje značajni R^2 pada
#fit.multi = lm(ap_hi ~ AgeinYr + active, filtered_data)
summary(fit.multi)
```
